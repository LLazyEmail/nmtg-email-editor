...
const { generateFullTemplate } = require("./src/template/generateFullTemplate");
const { getRowWithTwoBlocks } = require("./src/template/getRowWithTwoBlocks");
const { item } = require("./src/template/item");
